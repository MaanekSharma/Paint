...
def getName(screen,showFiles):
    ...
    arialFont = font.SysFont("Agency FB", 20)
    back = screen.copy()        # copy screen so we can replace it when done
    textArea = Rect(380,752,340,30) # make changes here.
    ...
    while typing:
        ...
        draw.rect(screen,(253, 173, 24,),textArea)        # draw the text window and the text.
        ...
        if cursorShow // 50 % 2 == 1:
            ...
            cy = textArea.y+3
            draw.rect(screen,(0,0,0),(cx,cy,2,textArea.height-6))
        myclock.tick(100)
        display.flip()
